...
export const ProjectEditModal: React.FC<ProjectEditModalProps> = ({
  ...
  if (!isOpen || !editingProd) return null;
      ...
      <div className="relative bg-white border border-slate-200 w-full max-w-2xl rounded-2xl overflow-hidden shadow-xl animate-in zoom-in-95 duration-200 flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto max-h-[70vh]">
          ...
          <div className="space-y-2">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-455 block">
              Project Cover Image
            </span>
                ...
                <div className="flex items-center gap-4 w-full px-4">
                  ...
                  <div className="flex-1 leading-tight min-w-0">
                    <span className="block text-xs font-bold text-slate-800 truncate">
                      {imageFile?.name || 'Current Poster'}
                    </span>
                    <span className="text-[10px] text-emerald-655 font-bold block mt-1">
                      Ready to save
                    </span>
                  </div>
                  <button
