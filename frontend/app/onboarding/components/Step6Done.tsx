  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-2 sm:py-4 animate-in fade-in zoom-in-95 duration-500">
      <div className="relative mb-4">
        <div className="w-20 h-20 bg-indigo-100 rounded-3xl flex items-center justify-center rotate-3 relative z-10 shadow-sm border border-indigo-200">
      ...
      <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-1">Your Onboarding Has Been Submitted!</h2>
      <h3 className="text-base sm:text-lg font-bold text-[#4f46e5] mb-4">Waiting for Admin Approval</h3>

      <p className="text-xs sm:text-sm text-slate-500 max-w-md mx-auto mb-6 leading-relaxed">
        Thank you for completing the onboarding process. Your application is currently under review by our administrator.
        ...
        <div className="flex items-center gap-3 text-left w-full sm:w-auto">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <span className="font-bold text-slate-900 text-sm">Pending Review</span>
              <span className="px-2 py-0.5 rounded bg-amber-50 text-amber-600 text-[10px] font-bold border border-amber-200/50">Under Review</span>
            </div>
          </div>
        </div>
