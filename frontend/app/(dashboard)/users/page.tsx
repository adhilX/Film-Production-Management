      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center bg-white p-4 border border-slate-200/80 rounded-2xl shadow-xs">
        <div className="relative flex-1 w-full">
          ...
          <input 
            ...
            className="w-full bg-white border border-slate-250 rounded-xl pl-10 pr-4 py-2 text-xs text-slate-900 focus:outline-none focus:border-indigo-650 transition"
          />
        </div>
        <select 
          value={filterRole}
          onChange={(e) => setFilterRole(e.target.value)}
          className="bg-white border border-slate-250 rounded-xl px-4 py-2 text-xs text-slate-700 focus:outline-none focus:border-indigo-650 transition w-full sm:w-auto appearance-none cursor-pointer"
        >
                  ...
                  <tr key={user._id} className="hover:bg-slate-50/50 transition">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button 
                        ...
                        className="inline-flex items-center justify-center p-1.5 text-slate-400 hover:text-indigo-650 hover:bg-indigo-50 rounded-xl transition cursor-pointer"
                        title="Edit User"
                      >
